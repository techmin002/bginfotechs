                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="about-content-one" data-sal="slide-left" data-sal-duration="1000"
                            ...
                            <div class="tj-sec-heading">
                                ...
                                <div class="desc">
                                    <p>
                                        At RotechInnovation Pvt Ltd, we specialize in providing comprehensive IT solutions
                        ...
                        <div class="tj-service-item text-center">
                            <div class="service-inner">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>
                                        Support for IT solutions is critical for maintaining the efficiency and
                                        functionality of your technology infrastructure.
                                        IT support services can range from troubleshooting technical issues to providing
                                        strategic guidance for improving your systems.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach ($data['testimonials'] as $testimonial)
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <p>"Choosing Rotech Innovation was the best decision we made.
                                            Their innovative solutions have helped us achieve our goals faster than we
                                            thought possible."
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="100">
                        <div class="tj-blog-item">
                            <div class="blog-image">
                                <a href="{{ route('blog.details',$blog->slug) }}"><img src="frontend/images/blog/blog-1.jpg"
                                        alt="Image" /></a>
                            </div>
