                    ...
                    <div class="sidebar-wrapper">
                        ...
                        <div class="details-item wow fadeInUp" data-wow-delay=".3s">
                            <div class="blog-thumb-image">
                                <a href="{{ route('blog.details',$blog->slug) }}"><img src="{{ asset('frontend/images/blog/blog-7.jpg') }}"
                                        alt="Image" /></a>
                            </div>
                            <div class="blog-meta">
                            ...
                            <p>file:///media/min/New%20Volume/wbency/themejunction.net/html/webency/demo/{{ route('blog.details',$blog->slug) }}
