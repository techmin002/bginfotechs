                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control"
                                                    placeholder="Enter Title "value="{{ $serviceCategory->title }}" required>
                                                @error('title')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="short_description" class="summernote" placeholder="Enter Short Description">{{ $serviceCategory->short_description }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="summernote" placeholder="Enter Short description">{{ $serviceCategory->description  }}</textarea>
                                                @error('description')
                                                    <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="preview mt-2">
                                                    <img src="{{ asset('upload/images/category/'.$serviceCategory->image) }}" width="200px">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
